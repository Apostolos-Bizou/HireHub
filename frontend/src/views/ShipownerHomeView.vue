...
<template>
  <div class="container owner-dash">
    ...
    <div class="kpi-grid">
      <div class="kpi-card">
        <div class="kpi-label" title="Συνολικός αριθμός εγγεγραμμένων ναυτικών στην πλατφόρμα">Registered seafarers</div>
        <div class="kpi-val kpi-blue">24,847</div>
        <div class="kpi-trend kpi-up">+1,230 this month</div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label" title="Ναυτικοί με επαληθευμένα πιστοποιητικά και έγγραφα">Verified profiles</div>
        <div class="kpi-val kpi-amber">18,290</div>
        <div class="kpi-trend">73.6% verification rate</div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label" title="Μέσος όρος βαθμολογίας από αξιολογήσεις συναδέλφων">Avg CrewScore</div>
        <div class="kpi-val kpi-green">78</div>
        <div class="kpi-trend kpi-up">+2.4 vs Q1</div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label" title="Συνολικές αξιολογήσεις που έχουν γραφτεί στην πλατφόρμα">Peer reviews total</div>
    ...
    <div class="kpi-grid">
      <div class="kpi-card">
        <div class="kpi-label" title="Πόσες shortlists δημιουργήσατε αυτόν τον μήνα">Your shortlists (MTD)</div>
        <div class="kpi-val">12</div>
        <div class="kpi-trend kpi-up">+4 vs last month</div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label" title="Υποψήφιοι που στείλατε σε manning agents">Candidates forwarded</div>
        <div class="kpi-val">38</div>
        <div class="kpi-trend kpi-up">+15% vs last month</div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label" title="Επιτυχημένες τοποθετήσεις — ναυτικοί που επιβιβάστηκαν">Successful placements</div>
        <div class="kpi-val kpi-green">24</div>
        <div class="kpi-trend">89% success rate</div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label" title="Μέσος χρόνος από αναζήτηση μέχρι τοποθέτηση">Avg time to hire</div>
    ...
    <div class="dash-layout">
      <div class="dash-main">
        ...
        <div class="charts-row">
          <div class="card section chart-card">
            <h2 title="Μηνιαίες τοποθετήσεις και shortlists — τάση τελευταίου 6μηνου">Monthly placements</h2>
            <canvas id="placementChart" style="width:100%;height:200px;"></canvas>
          </div>
          <div class="card section chart-card">
            <h2 title="Ζήτηση ανά τύπο πλοίου — tankers, bulk, container κλπ">Vessel type demand</h2>
      ...
      <aside class="dash-sidebar">
        ...
        <!-- Platform Stats -->
        <div class="card section">
          <h3 title="Στατιστικά πλατφόρμας — προβολές, αναζητήσεις, AI ακρίβεια">Platform performance</h3>
          <div class="stat-list">
        ...
        <!-- Quick Actions -->
        <div class="card section">
          <h3 title="Γρήγορες ενέργειες — αναζήτηση, AI, shortlists, μηνύματα">Quick actions</h3>
